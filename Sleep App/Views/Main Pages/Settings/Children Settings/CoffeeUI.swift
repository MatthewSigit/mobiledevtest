...
struct CoffeeUI: View {
    ...
    @AppStorage ("coffeehours") var coffeehours:Int = 6
        ...
        NavigationView {
            ...
            ZStack() {
                ...
                VStack() {
                    ...
                    VStack {
                        Text("Coffee Settings")
                            .font(.largeTitle)
                            .padding()
                        
                        Toggle("Coffee Notifications", isOn: $coffeenotifications)
                            .font(.title2)
                            .padding()
                        
                        Text("How many hours prior to sleeping can you drink coffee? (minimum)")
                            .multilineTextAlignment(.center)
                            .padding()
                        
                        Picker(selection: $coffeehours, label: Text("Coffee Hours")) {
                            Text("0").tag(0)
                            Text("1").tag(1)
                            Text("2").tag(2)
                            Text("3").tag(3)
...
struct CoffeeUI_Previews: PreviewProvider {
