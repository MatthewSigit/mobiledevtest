...
struct SugarUI: View {
    ...
    @AppStorage ("sugarhours") var sugarhours:Int = 4
            ...
            ZStack() {
                ...
                VStack() {
                    ...
                    VStack {
                        ...
                        Toggle("Sugar Notifications", isOn: $sugarnotifications)
                            .font(.title2)
                            .padding()
                        
                        Text("How many hours prior to sleeping can you have sugar? (minimum)")
                            .multilineTextAlignment(.center)
                            .padding()
                        }
                        Picker(selection: $sugarhours, label: Text("Sugar Hours")) {
                            Text("0").tag(0)
                            Text("1").tag(1)
                            Text("2").tag(2)
                            Text("3").tag(3)
...
struct SugarUI_Previews: PreviewProvider {
